...
polygon(c(pDat7$date,pDat7$date[nrow(pDat7):1]),c(pDat7$clinton-100*pDat7$moeC,pDat7$clinton[nrow(pDat7):1]+100*pDat7$moeC[nrow(pDat7):1]),col=rgb(0,0,1,0.5),border=rgb(0,0,1,0.1))
polygon(c(pDat7$date,pDat7$date[nrow(pDat7):1]),c(pDat7$trump-100*pDat7$moeT,pDat7$trump[nrow(pDat7):1]+100*pDat7$moeT[nrow(pDat7):1]),col=rgb(1,0,0,0.5),border=rgb(1,0,0,0.1))

polygon(c(pDat14$date,pDat14$date[nrow(pDat14):1]),c(pDat14$clinton-100*pDat14$moeC,pDat14$clinton[nrow(pDat14):1]+100*pDat14$moeC[nrow(pDat14):1]),col=rgb(0,0,1,0.5),border=rgb(0,0,1,0.1))
polygon(c(pDat14$date,pDat14$date[nrow(pDat14):1]),c(pDat14$trump-100*pDat14$moeT,pDat14$trump[nrow(pDat14):1]+100*pDat14$moeT[nrow(pDat14):1]),col=rgb(1,0,0,0.5),border=rgb(1,0,0,0.1))

polygon(c(pDat21$date,pDat21$date[nrow(pDat21):1]),c(pDat21$clinton-100*pDat21$moeC,pDat21$clinton[nrow(pDat21):1]+100*pDat21$moeC[nrow(pDat21):1]),col=rgb(0,0,1,0.5),border=rgb(0,0,1,0.1))
polygon(c(pDat21$date,pDat21$date[nrow(pDat21):1]),c(pDat21$trump-100*pDat21$moeT,pDat21$trump[nrow(pDat21):1]+100*pDat21$moeT[nrow(pDat21):1]),col=rgb(1,0,0,0.5),border=rgb(1,0,0,0.1))
...
png("/Users/gregorymatthews/Dropbox/StatsInTheWild/TrumpVsClintonStatePolls.png",h=10,w=10,units="in",res=100)
