...
png("/Users/gregorymatthews/SuperBowlSquares2019_Recent.png", res = 300, units = "in", h = 6, w =6)
p <- ggplot(nfl[nfl$season>=2000,], aes(x=factor(score1%%10),y=factor(score2%%10)))
h3 <- p + stat_bin2d()  + scale_fill_gradientn(colors=r) + xlab("Home Score") + ylab("Away Score")
h3
dev.off()
